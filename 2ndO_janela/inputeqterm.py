...
def iniciar():
    ...
    solve_edo(x0, x_final, y0, z0, n)


#Função para resolver o usando rk45
def solve_edo(x0, x_final, y0, z0, n):
    ...
    result_label.config(text=f"y1 = {y_values[n]:.6f}, z1 = {z_values[n]}")
...
n_label = tk.Label(root, text="numero de iterações (n): ")
n_label.pack()
