...
def inciar_3nd_ordem_i():
    equation = str(equation_entry3.get())
    x0 = float(x0_entry3.get())
    y0 = float(y0_entry3.get())
    y_prime0 = float(z0_entry3.get())
    y_double_prime0 = float(w0_entry3.get())
    xf = float(x0_final_entry3.get())
    num_points = int(np_entry3.get())

    h = (xf - x0) / num_points

    x = Symbol('x')
    y_s = Function('y')(x)
    dydx_s  = Function('dydx')(x)
    d2ydx2_s  = Function('d2ydx2')(x)

    eq1 = eval(equation)

    x_v, y_v, z_v, w_v = solve_runge_kutta_4nd(eq1)

def solve_runge_kutta_4nd(equation_str):
    eq2 = equation_str
    x, y, dydx, d2ydx2 = symbols('x y dydx d2ydx2')
    eq2 = sympify(eq2)
    f = lambdify((x, y, dydx_s, d2ydx2_s), eq2, modules=['numpy'])
    x_vals, y_vals, y_prime_vals, y_double_prime_vals = runge_kutta_third_order(f, x0, y0, y_prime0, y_double_prime0, h, num_points)
    return x_vals, y_vals, y_prime_vals, y_double_prime_vals

def runge_kutta_third_order(f, x0, y0, y_prime0, y_double_prime0, h, num_points):
...
solve_button1_1 = tk.Button(tab1, text="Calcular y1", command=iniciar_1nd_ordem_i, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
solve_button1_1.pack(pady=(20, 0))

# Botão para calcular y1
solve_button1_2 = tk.Button(tab1, text="Listar y1", command=iniciar_1nd_ordem_l, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
...
# Botão para calcular y1
solve_button2_1 = tk.Button(tab2, text="Calcular y1 e z1", command=iniciar_2nd_ordem_i, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
solve_button2_1.pack(pady=(10, 0))

# Botão para listar y1
solve_button2_2 = tk.Button(tab2, text="Listar y1 e z1", command=iniciar_2nd_ordem_l, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
...
# Add a new tab for third-order equations
tab3 = ttk.Frame(notebook)
notebook.add(tab3, text='3° Ordem')

# Input fields for third-order equations
equation_label3 = tk.Label(tab3, text="Entre com a EDO (use x, y, y' e y''): ")
equation_label3.pack()

equation_entry3 = tk.Entry(tab3)
equation_entry3.pack()

x0_inicial_label3 = tk.Label(tab3, text="Digite o valor inicial de x, (x0): ")
x0_inicial_label3.pack()

x0_inicial_entry3 = tk.Entry(tab3)
x0_inicial_entry3.pack()

x0_final_label3 = tk.Label(tab3, text="Digite o valor final de x, (xf): ")
x0_final_label3.pack()

x0_final_entry3 = tk.Entry(tab3)
x0_final_entry3.pack()

y0_label3 = tk.Label(tab3, text="Digite o valor inicial de y, y(x0): ")
y0_label3.pack()

y0_entry3 = tk.Entry(tab3)
y0_entry3.pack()

z1_0_label3 = tk.Label(tab3, text="Digite o valor inicial de y', y'(x0): ")
z1_0_label3.pack()

z1_0_entry3 = tk.Entry(tab3)
z1_0_entry3.pack()

z2_0_label3 = tk.Label(tab3, text="Digite o valor inicial de y'', y''(x0): ")
z2_0_label3.pack()

z2_0_entry3 = tk.Entry(tab3)
z2_0_entry3.pack()

n_label3 = tk.Label(tab3, text="Numero de pontos (n): ")
n_label3.pack()

n_entry3 = tk.Entry(tab3)
n_entry3.pack()

p_label3 = tk.Label(tab3, text="Ponto desejado (p): ")
p_label3.pack()

p_entry3 = tk.Entry(tab3)
p_entry3.pack()

# Button to calculate third-order results
solve_button3 = tk.Button(tab3, text="Calcular Resultados", command=iniciar_2nd_ordem_i, bd=2, bg='#107db2',
                          fg='white', font=('verdana', 8, 'bold'))
solve_button3.pack()
