...
solve_button1 = tk.Button(tab1, text="Calcular y1", command=inciar_1nd_ordem_i, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
solve_button1.pack(pady=(20, 0))

# Botão para calcular y1
solve_button2 = tk.Button(tab1, text="Listar y1", command=inciar_1nd_ordem_l, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
...
# Botão para calcular y1
solve_button3 = tk.Button(tab2, text="Calcular y1 e z1", command=inciar_2nd_ordem_i, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
solve_button3.pack(pady=(10, 0))

# Botão para listar y1
solve_button4 = tk.Button(tab2, text="Listar y1 e z1", command=inciar_2nd_ordem_l, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
...
def on_configure(event):
    ...
    canvas3.config(width=event.width)
    canvas3.itemconfig(frame_aux_id, width=event.width)
...
# Criando Scroll
scroll = ttk.Scrollbar(root, orient=tk.VERTICAL, command=canvas3.yview)
...
frame_aux_id = canvas3.create_window((0,0), window=frame_aux, anchor = "nw" )
canvas3.bind('<Configure>',on_configure)

# Valores pedidos ao usuario
derivative_label3 = tk.Label(frame_aux, text="Digite a derivada de y (y'): ")
derivative_label3.pack(pady=(10,0))

derivative_entry3 = tk.Entry(frame_aux)
derivative_entry3.pack(pady=(5,0))
...
# Botão para calcular y1
solve_button5 = tk.Button(frame_aux, text="Calcular y1", command=inciar_1nd_ordem_i, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
solve_button5.pack(pady=(5,0))

# Botão para calcular y1
solve_button6 = tk.Button(frame_aux, text="Listar y1", command=inciar_1nd_ordem_l, bd=2, bg = '#107db2', fg ='white'
                            , font = ('verdana', 8, 'bold'))
solve_button6.pack(pady=(5,0))

#Botão para plotar y/x
# Botão para plotar grafico 
plot_button_third_order = tk.Button(tab2, text="Plotar Gráfico", command=plot_graph_second_order, bd=2, bg='#107db2',
                                      fg='white', font=('verdana', 8, 'bold'))
plot_button_third_order.pack(pady=(10, 0))
