...
def solve_runge_kutta(equation_str):
    ...
    _, y_values = runge_kutta_4th_order(f, x0, y0, x_final, n)
...
n_label = tk.Label(root, text="Digite a quantidade de pontos (np): ")
n_label.pack()

np_entry = tk.Entry(root)
np_entry.pack()

p_label = tk.Label(root, text="Digite o ponto que deseja (p): ")
p_label.pack()
